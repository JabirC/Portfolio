...
const Footer = () => {
  ...
  return (
    <>
    <div className="z-1 md:fixed flex flex-col justify-center items-center pt-10 space-y-6 md:space-y-4 md:pb-10  bottom-0 left-0 w-full md:w-20 lg:w-24 xl:w-32 h-24 md:h-400">
    ...
    <div className=" text-xs text-[#8892b0] text-center pb-10">
