...
const Footer = () => {
  ...
  return (
    <div className="z-1 md:fixed flex flex-col justify-center items-center pt-10 space-y-6 md:space-y-4 pb-10 md:pb-0 bottom-0 left-0 w-full md:w-20 xl:w-28 h-24 md:h-400">
