    ...
    return (
      <div id="contact" className="flex flex-col items-center  p-6  mt-40 mb-52">
            ...
            <div className=" w-full text-center max-w-2xl  w-full   flex flex-col items-center justify-center">
                <div className="text-md flex flex-row items-center justify-center space-x-2 mb-6"> <div className="text-[#64ffda]">04.</div> 
               ...
               <div className="flex relative text-[#64ffda] ">
                    <button className="relative z-10 h-14 w-32 border border-[#64ffda] bg-[#0a192f] rounded-md  text-sm transition-all duration-300 transition-transform transform hover:-translate-y-1 hover:-translate-x-1">Say Hello</button>
